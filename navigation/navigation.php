...
<body>
    ...
    <template id="chat-template">
        <div onclick="openForm()">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="chat"
                viewBox="0 0 16 16">
                <path
    ...
    <template id="footer-template">
        <footer>
            <div class="footer">
                <div class="sv-icons">
                    <a href="https://www.facebook.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="my-icon" viewBox="0 0 16 16">
                        <defs>
                    ...
                    <a href="https://www.instagram.com/?hl=en" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="my-icon" viewBox="0 0 16 16">
                        <path fill="url(#gradient)"
                    ...
                    <a href="https://web.whatsapp.com/" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="my-icon" viewBox="0 0 16 16">
                        <path fill="url(#gradient)"
