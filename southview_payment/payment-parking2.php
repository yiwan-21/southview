...
<body>
    ...
    <form name="paymentPForm2" method="post" action = "payment-parking2.php">
            ...
            <div class="mx-5 my-5 " id="grey-bg" style="background-color: rgb(0,0,0,0.5);">
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                        <a href="../southview_payment/payment-parking1.php"><button type="button" class="btn"
                                id="self-pay">Pay My Bills</button></a>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                        <a href="../southview_payment/payment-parking2.php"><button type="button" class="btn active"
