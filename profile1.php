                                    ...
                                    <div class="row justify-content-center mt-3">
                                        ...
                                        <button type="button" class="btn" id="btn-setting">
                                            <?php
                                                ...
                                                // header("http://localhost:8000/southview_profile/profile2.php");
                                                // echo "<td><a href=\"edit.php?Resident_svID=$singleRow[Resident_svID]\">Edit</a> | <a href=\"delete.php?Resident_svID=$singleRow[Resident_svID]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                                                // mysqli_close($mysqli);
                                            ?>
                                        </button>  
                                            <!-- <a href="../southview_profile/profile2.php"><button type="button"
                                            class="btn" id="btn-setting">Edit Profile</button></a> -->
            ...
            <div class="content">
                <div class="container text-center">
                    <form name="form2" method="post" action="profile1.php">
                        ...
                        <!-- <input type="hidden" name="Resident_svID" value=<?php echo $_GET['Resident_svID'];?>> -->
